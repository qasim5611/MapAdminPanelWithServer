...
import { UpdateFooter } from "../redux/actions/FooterAction";
...
const FooterEdit = (props) => {
  ...
  useEffect(() => {
    axios.post(API + "/api/footer/get_one", { _id: item_id }).then((result) => {
              ...
              <Col xs="12" md="9">
                <form>
                  <div class="form-group">
                    ...
                    >
                      <option value="0">
                        Select Footer Position From Left to Right
                      </option>
                      <option
                        value="1"
                        selected={state.footer_position == 1 && "selected"}
                      >
                        First
                      </option>
                      <option
                        value="2"
                        selected={state.footer_position == 2 && "selected"}
                      >
                        Second
                      </option>
                      <option
                        value="3"
                        selected={state.footer_position == 3 && "selected"}
                      >
                        Third
                      </option>
                      <option
                        value="4"
                        selected={state.footer_position == 4 && "selected"}
                      >
                        Forth
                      </option>
                    </select>
