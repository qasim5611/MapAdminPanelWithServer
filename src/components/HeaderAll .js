...
const Header = () => {
  ...
  const isHeaderDeleted = useSelector(
    (state) => state.headerReducer.isHeaderDeleted
  );
  ...
  useEffect(() => {
    axios.get(API + "/api/header/get_all").then((result) => {
      setEditorList(result.data);
      setEditorList2(result.data);
    });
  }, [isHeaderDeleted, success]);

  const deleteHeaderItem = (id) => {
    dispatch(deleteHeaderAction({ _id: id, admin_id }));
  };
      ...
      <div class="content-wrapper">
        ...
        >
          ...
          <Row className="table-header">
            <Col xs="12" md="2">
              <h2 class="section-title">Header Section</h2>
            </Col>
            <Col xs="12" md="10">
                  ...
                  <table class="table table-bordered">
                    <tbody>
                      <tr>
                        ...
                        <th class="active">Header Title</th>
                        <th class="active">Header Desc</th>
                      ...
                      {editorList.map((item, ind) => {
                        return (
                          <tr>
                            ...
                            <td>
                              <Link to={`/admin/header_edit/${item._id}`}>
                                <FontAwesomeIcon
                                  icon={faUserEdit}
