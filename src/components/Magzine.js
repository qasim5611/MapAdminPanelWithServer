...
import {
  deleteArticle,
  deleteSubCategory,
} from "../redux/actions/MagzineAction";
...
const Category = () => {
  ...
  const isCategoryDeleted = useSelector(
    (state) => state.MagzineReducer.isArticleDeleted
  );
  ...
  useEffect(() => {
    axios.get(API + "/api/magzine/get").then((result) => {
                  ...
                  <table class="table table-bordered">
                    <tbody>
                      <tr>
                        ...
                        <th class="active">Blog Short Intro</th>
