...
import { updateTalkshow } from "../redux/actions/Talkshow_action";
      ...
      <div class="content-wrapper">
        ...
        >
          <Row className="table-header">
            <Col xs="12" md="12">
              <h2 class="section-title">Update Talk Show</h2>
            </Col>
          </Row>
          <div class="row">
            <Row>
...
export default withRouter(TalkShowUpdates);
