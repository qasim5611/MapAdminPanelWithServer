...
import { createStory } from "../redux/actions/topStoryAction";
            ...
            <Row>
              <Col xs="12" md="9">
                <form>
                  ...
                  <div class="form-group">
                    <label for="pwd">Create Descriptions</label>
...
export default withRouter(UpdateAboutText);
