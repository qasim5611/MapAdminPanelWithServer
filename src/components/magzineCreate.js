...
import { createArticle } from "../redux/actions/MagzineAction";
...
const CreateNewArticle = (props) => {
  ...
  let success = useSelector((state) => state.MagzineReducer.msg);
            ...
            <Row>
              <Col xs="12" md="9">
                <form>
                  ...
                  <div class="form-group">
                    <label for="pwd">Short Description / 100 Charc Allowed</label>
                    <input
                      type="text"
                      class="form-control"
                      required
                  ...
                  <div class="form-group">
                    <label for="pwd">Magzine Blog Image </label>
                    <input
                      type="file"
                      class="form-control"
                      required
