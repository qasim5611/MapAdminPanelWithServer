...
import { updateMagzine } from "../redux/actions/MagzineAction";
      ...
      <div class="content-wrapper">
        ...
        >
          <Row className="table-header">
            <Col xs="12" md="12">
              <h2 class="section-title">Update Magzine</h2>
            </Col>
          </Row>
          <div class="row">
            <Row>
              <Col xs="12" md="9">
                <form>
                  <div class="form-group">
                    <label for="pwd">Update Title</label>
                    <input
                      type="text"
                      class="form-control"
                      required
                  ...
                  <div class="form-group">
                    <label for="pwd">Auther/Your Name</label>
                    <input
                      name="auther"
                      type="text"
                      class="form-control"
...
export default withRouter(MagzineUpdate);
