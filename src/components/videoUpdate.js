...
import { updateVideo } from "../redux/actions/videoArticleAction";
...
const VideoUpdate = (props) => {
  ...
  // let success = useSelector((state) => state.topStoryReducer.msg);
  ...
  let successfully = useSelector((state) => state.topStoryReducer.isVideoUpdatae);
  useEffect(() => {
      ...
      <div class="content-wrapper">
        ...
        >
          <Row className="table-header">
            <Col xs="12" md="12">
              <h2 class="section-title">Update Video</h2>
            </Col>
          </Row>
          <div class="row">
            <Row>
...
{/*
                  ...
                  {/* <div class="form-group">
                    <label for="pwd">Video Descriptions</label>
